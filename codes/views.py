...
from .custom_responses import (create_zip_code_not_found_response,
                               create_zip_code_response)
...
class CodesView(APIView):
    ...
    def append_settlements_to_response(self, zip_code, resp):
        ...
        """
        settlements_lookup = ZipCodes.objects.filter(d_codigo=zip_code)
    ...
    def create_settlement_obj(self, settlement):
        ...
        settlement = {
            ...
            "settlement_type": {"name": settlement["d_tipo_asenta"].upper()},
        }
        return settlement
